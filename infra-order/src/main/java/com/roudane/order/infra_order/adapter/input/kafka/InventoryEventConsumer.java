package com.roudane.order.infra_order.adapter.input.kafka;
...
public class InventoryEventConsumer {
    ...
    @KafkaListener(topics = "${kafka.topics.inventory-reserved:inventory-reserved-events}", groupId = "${spring.kafka.consumer.group-id}")
