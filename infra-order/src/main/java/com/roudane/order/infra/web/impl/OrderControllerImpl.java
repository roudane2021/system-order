...
public class OrderControllerImpl implements IOrderController {
    ...
    public ResponseEntity<OrderCreateResponseDto> createOrder(@Valid @RequestBody final OrderCreateRequestDto orderCreateRequest) {
        ...
        OrderModel createdOrder = orderService.createOrder(orderModelToCreate);
    ...
    public ResponseEntity<Set<OrderDto>> listOrders() {
        Set<OrderModel> orderModels = orderService.listOrder();
    ...
    public ResponseEntity<PageResult<OrderDto>> listOrders(@Valid @RequestBody final List<CriteriaApplication> criteriaApplications,
        ...
        PageResult<OrderDto> orderModels = orderService.findOrderCriteria(criteriaApplications, page , size).map(IOrderMapper.INSTANCE::toDto);
    ...
    public ResponseEntity<OrderDto> updateOrder(@PathVariable final Long id, @RequestBody final OrderUpdateRequestDto orderUpdateRequestDto) {
        ...
        OrderModel updatedOrder = orderService.updateOrder(orderModelToUpdate);
    ...
    public ResponseEntity<OrderDto> payOrder(@PathVariable final Long id) {
        OrderModel paidOrder = orderService.payOrder(id);
    ...
    public ResponseEntity<OrderDto> shipOrder(@PathVariable final Long id, @RequestBody final ShipOrderRequestDto shipOrderRequestDto) {
        OrderModel shippedOrderModel = orderService.shipOrder(id, shipOrderRequestDto.getTrackingNumber());
