...
IMAGE_INFRA_ORDER_NAME="roudane/infra_order"
IMAGE_INFRA_INVENTORY_NAME="roudane/infra_inventory"
IMAGE_INFRA_NOTIFICATION_NAME="roudane/infra_notification"
IMAGE_CONFIG_SERVER_NAME="roudane/config-server"
IMAGE_EUREKA_SERVER_NAME="roudane/eureka-server"
IMAGE_GATEWAY_NAME="roudane/gateway-server"
