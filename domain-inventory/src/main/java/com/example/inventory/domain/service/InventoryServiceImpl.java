...
import com.example.inventory.domain.event.OrderCancelledEvent;
...
import com.example.inventory.domain.event.OrderItemDTO;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    @Override
    public Object handleOrderCreated(OrderCreatedEvent event) {
        ...
        if (requestedItems == null || requestedItems.isEmpty()) {
            ...
            // For now, let's assume this could be a valid scenario handled by an empty InventoryReservedEvent.
             return new InventoryReservedEvent(event.getOrderId(), new ArrayList<>());
        }
        ...
        for (OrderItemDTO requestedItem : requestedItems) {
            ...
            if (inventoryItem == null || inventoryItem.getQuantity() < requestedItem.getQuantity()) {
                ...
                return new InventoryDepletedEvent(event.getOrderId(), depletionReason, requestedItems);
            }
        ...
        return new InventoryReservedEvent(event.getOrderId(), successfullyReservedItems);
    }
