package com.roudane.order.infra_notification.messaging.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean("OrderShippedEventContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, OrderShippedEvent> OrderShippedEventContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OrderShippedEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(createConsumerFactory(OrderShippedEvent.class));
        return factory;
    }
}
